...
act_coverage$acro = factor(act_coverage$acro, levels = c('nov','nds','lex','gfs','tor','tru','pfs','ran'))
act_coverage %>%
  group_by(acro) %>%
  dplyr::summarise(
    count = n(),
...
sat_coverage$acro = factor(sat_coverage$acro, levels = c('pfs','nds','lex','gfs','tor','tru','nov','ran'))
sat_coverage %>%
  group_by(acro) %>%
  dplyr::summarise(
    count = n(),
