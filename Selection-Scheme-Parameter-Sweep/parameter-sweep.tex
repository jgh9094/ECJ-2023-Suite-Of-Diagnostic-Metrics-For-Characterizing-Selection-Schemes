...
\NormalTok{p_theme <-}\StringTok{ }\KeywordTok{theme}\NormalTok{(}
  \DataTypeTok{text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size =} \DecValTok{19}\NormalTok{),}
  ...
  \DataTypeTok{legend.title=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{13}\NormalTok{),}
  \DataTypeTok{legend.text=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{13}\NormalTok{),}
  \DataTypeTok{axis.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{19}\NormalTok{),}
  \DataTypeTok{axis.text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{19}\NormalTok{),}
...
## 0.1 1.00000 -       -       -       -       -      
## 0.3 1.00000 1.00000 -       -       -       -      
## 0.6 0.16877 1.00000 1.00000 -       -       -      
## 1.2 0.00547 0.86805 0.59878 1.00000 -       -      
## 2.5 1.2e-07 4.7e-05 2.5e-05 0.00045 0.18225 -      
## 5   1.8e-07 5.7e-05 3.1e-05 0.00050 0.14935 1.00000
## 
## P value adjustment method: bonferroni
\end{verbatim}
...
## 0.1 7.8e-13 -       -       -       -       -      
## 0.3 1.3e-10 0.16405 -       -       -       -      
## 0.6 3.6e-10 0.02571 1.00000 -       -       -      
## 1.2 6.7e-09 0.05563 1.00000 1.00000 -       -      
## 2.5 4.6e-08 0.00073 1.00000 1.00000 1.00000 -      
## 5   4.2e-09 0.03076 1.00000 1.00000 1.00000 1.00000
## 
## P value adjustment method: bonferroni
\end{verbatim}
...
## 2.5 2.3e-10 -       -       -       -       -      
## 1.2 4.5e-10 0.59041 -       -       -       -      
## 0.6 1.1e-10 0.02305 1.0e-05 -       -       -      
## 0.3 7.5e-11 3.9e-06 5.4e-10 0.15225 -       -      
## 0.1 8.3e-11 0.00026 3.5e-08 1.00000 1.00000 -      
## 5   6.5e-11 1.3e-11 3.4e-14 2.8e-12 2.3e-07 1.0e-09
## 
## P value adjustment method: bonferroni
\end{verbatim}
...
## 0.3 1.00   1.00   -      -      -      -     
## 0.6 0.38   0.11   1.00   -      -      -     
## 1.2 0.51   0.22   1.00   1.00   -      -     
## 2.5 0.52   0.23   1.00   1.00   1.00   -     
## 5   <2e-16 <2e-16 <2e-16 <2e-16 <2e-16 <2e-16
## 
## P value adjustment method: bonferroni
\end{verbatim}
...
## 0.3 1       1       1       -       -       -      
## 0.1 1       1       1       1       -       -      
## 5   3.8e-11 1.9e-10 9.8e-12 2.4e-11 6.9e-12 -      
...
## 1.2 1       1       1       -       -       -      
## 2.5 1       1       1       1       -       -      
## 5   6.9e-12 2.4e-11 9.8e-12 1.9e-10 3.8e-11 -      
## 0   < 2e-16 < 2e-16 < 2e-16 < 2e-16 < 2e-16 < 2e-16
## 
## P value adjustment method: bonferroni
\end{verbatim}
...
## 5   1.9e-15 -       -       -      -      -     
## 2.5 2.8e-16 1.1e-07 -       -      -      -     
## 1.2 < 2e-16 1.8e-11 0.0027  -      -      -     
## 0.6 < 2e-16 5.1e-14 1.1e-08 0.1164 -      -     
## 0.3 < 2e-16 1.7e-14 4.5e-09 0.5302 1.0000 -     
## 0.1 < 2e-16 8.8e-14 2.2e-09 0.0125 1.0000 1.0000
## 
## P value adjustment method: bonferroni
\end{verbatim}
...
## 2.5 0.20235 0.12623 0.00387 1.00000 -       -      
## 5   3.5e-05 4.8e-06 1.2e-07 0.00012 0.01146 -      
## 0   < 2e-16 < 2e-16 < 2e-16 < 2e-16 < 2e-16 < 2e-16
## 
## P value adjustment method: bonferroni
\end{verbatim}
...
## 6 30       50      0    82   90.5  90.5    97  3.75
\end{verbatim}
...
## Kruskal-Wallis chi-squared = 257.39, df = 5, p-value < 2.2e-16
\end{verbatim}
