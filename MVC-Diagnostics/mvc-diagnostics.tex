...
\KeywordTok{ggplot}\NormalTok{(interval_df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{acro, }\DataTypeTok{y=}\NormalTok{pop_fit_max}\OperatorTok{/}\NormalTok{DIMENSIONALITY,}\DataTypeTok{fill=}\NormalTok{Generation,}\DataTypeTok{color=}\NormalTok{Generation,}\DataTypeTok{shape=}\NormalTok{Generation)) }\OperatorTok{+}\StringTok{ }
...
\KeywordTok{ggplot}\NormalTok{(., }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Generation, }\DataTypeTok{y=}\NormalTok{pop_fit_max}\OperatorTok{/}\NormalTok{DIMENSIONALITY,}\DataTypeTok{fill=}\NormalTok{Generation,}\DataTypeTok{color=}\NormalTok{Generation,}\DataTypeTok{shape=}\NormalTok{Generation)) }\OperatorTok{+}\StringTok{ }
