...
\StringTok{  }\KeywordTok{guides}\NormalTok{(}
    \DataTypeTok{shape=}\KeywordTok{guide_legend}\NormalTok{(}\DataTypeTok{nrow=}\DecValTok{3}\NormalTok{, }\DataTypeTok{title.position =} \StringTok{"bottom"}\NormalTok{, }\DataTypeTok{title =} \StringTok{'Selection Scheme'}\NormalTok{),}
    \DataTypeTok{color=}\KeywordTok{guide_legend}\NormalTok{(}\DataTypeTok{nrow=}\DecValTok{3}\NormalTok{, }\DataTypeTok{title.position =} \StringTok{"bottom"}\NormalTok{, }\DataTypeTok{title =} \StringTok{'Selection Scheme'}\NormalTok{),}
    \DataTypeTok{fill=}\KeywordTok{guide_legend}\NormalTok{(}\DataTypeTok{nrow=}\DecValTok{3}\NormalTok{, }\DataTypeTok{title.position =} \StringTok{"bottom"}\NormalTok{, }\DataTypeTok{title =} \StringTok{'Selection Scheme'}\NormalTok{)}
\NormalTok{  )}
